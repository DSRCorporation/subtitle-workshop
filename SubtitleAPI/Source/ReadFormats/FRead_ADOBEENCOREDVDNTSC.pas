...
// File Description: Adobe Encore DVD NTSC subtitle format reading functionality

//added by adenry
function FileToSubtitles_ADOBEENCOREDVDNTSC(var Subtitles: TSubtitles; tmpSubFile: TSubtitleFile; FPS: Single; ExtraTime: Integer): Boolean;
var
  i           : Integer;
  InitialTime : Integer;
  FinalTime   : Integer;
